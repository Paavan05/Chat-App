...
const ComingSoon = ({ title, subtitle }) => (
  <div className="min-h-screen bg-[#f7f8fc] dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors flex flex-col">
    <Navbar />
...
const About = () => {
  return (
    <ComingSoon
      title="About page is on its way"
      subtitle="Learn more about our mission, team, and roadmap. We’re putting the finishing touches on this page."
    />
  );
};
